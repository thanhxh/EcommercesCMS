...
public class ConstantGlobal {
    ...
    public final static String EMAIL = PropertiesHelpers.getValue("EMAIL");
    ...
    public final static String CATEGORIES = PropertiesHelpers.getValue("CATEGORIES");
    public final static String ALL_PRODUCT = PropertiesHelpers.getValue("ALL_PRODUCT");
